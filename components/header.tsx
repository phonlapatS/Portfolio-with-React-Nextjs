...
export function Header() {
  ...
  <header className='z-[999] relative'>
    ...
    dark:border-black/40 dark:bg-opacity-75'
        initial={{ y: -100, x:"-50%", opacity: 0}} /*Edit Motion*/
    ...
    py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0' >
        ...
        sm:w-[initial] sm:flex-nowrap sm:gap-5'>
            {links.map(link => (
                ...
                >
                <Link className={clsx(
                        "flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition darkLtext-gray-500 dark:hover:text-gray-300"
